...
<body style = "font-size:20px">
	SSHE示例项目是一个由Eclipse Kepler创建，<br/><br/>
	Struts2.3.x+Spring3.2.x+Hibernate4.2.x+CXF2.7.x+EasyUI1.3.4+Maven架构的示例程序<br/><br/>
	当前示例演示了包括：权限控制、超大附件文件上传、EasyUI基本组件使用等等功能，具体请自行看本示例演示功能<br/><br/>
	SSHE框架环境需求：JAVA环境：JDK7+；<br/><br/>
	数据库环境：oracle10g+/sqlserver2000+/mysql5+；<br/><br/>
	WEB容器环境：jetty6+/tomcat6+；<br/><br/>
	编译环境：maven：3.x+ <br/><br/>
	<hr />
<%-- 	<h1>
