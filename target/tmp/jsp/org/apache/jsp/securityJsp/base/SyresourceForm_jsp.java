...
public final class SyresourceForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (id == null) {
      ...
      out.write("\t\t\t\turl = sy.contextPath + '/base/syresource!update.sy';\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\turl = sy.contextPath + '/base/syresource!save.sy';\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$.post(sy.contextPath + '/base/syresource!getById.sy', {\r\n");
      ...
      out.write("/base/syresourcetype!doNotNeedSecurity_combobox.sy',panelHeight:'auto'\" style=\"width: 155px;\"></select></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      ...
      out.print(contextPath);
      out.write("/base/syresource!doNotNeedSecurity_getMainMenu.sy'\" style=\"width: 155px;\"></select><img class=\"iconImg ext-icon-cross\" onclick=\"$('#syresource_id').combotree('clear');\" title=\"清空\" /></td>\r\n");
